...
%------ SPECIFY DATA ------------------------------------------------------
PATH= 'D:\aa_work\新学期项目及论文\心电图项目\数据集\MIT-BIH Arrhythmia Database\mat'; % path, where data are saved
...
%------ DISPLAY DATA ------------------------------------------------------
save(strcat( FILE_NO,'.mat'),'M')
save(strcat( FILE_NO,'time.mat'),'TIME')
save(strcat( FILE_NO,'ATRTIMED.mat'),'ATRTIMED')
save(strcat( FILE_NO,'ANNOTD.mat'),'ANNOTD')
