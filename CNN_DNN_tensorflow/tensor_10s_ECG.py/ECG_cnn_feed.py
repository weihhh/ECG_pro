...
flags.DEFINE_integer('max_steps', 9000, 'Number of steps to run trainer.')

#根据不同模型改变层数
flags.DEFINE_integer('conv1', 64, 'Number of units in conv layer 1.')
flags.DEFINE_integer('conv2', 128, 'Number of units in conv layer 2.')
flags.DEFINE_integer('full', 1024, 'Number of units in conv layer 2.')
...
def run_training():
  ...
  with tf.Graph().as_default():
    ...
    # accuracy_validation=tensor_ecg_model.accuracy_validation(logits, labels_placeholder)
    # accuracy_test=tensor_ecg_model.accuracy_test(logits, labels_placeholder)
