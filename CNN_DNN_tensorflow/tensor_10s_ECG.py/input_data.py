...
def read_data_sets():
    ...
    print('所有心电信号标注：{} '.format(np.array(all_ann_list).shape))#(46, 180, 10)
    ...
    print('all_spike_matrix : ',all_spike_matrix.shape)#(8280, 3600)
    ...
    x_train,x_validation,y_train,y_validation=train_test_split(ECG_data,all_ann_matrix,test_size=0.3)
